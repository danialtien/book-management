...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 1. Call DAO : new object DAO va call method from DAO
            ...
            if (result != null) {
                ...
                url = (String) siteMap.get(MyAppConstant.LoginFeatures.SEARCH_ACTION);
                HttpSession session = request.getSession(); // login thanh cong -> luu tru thong tin nguoi dung  va phai tao moi
